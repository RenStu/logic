...
The vigor of an entanglement lies in the equivalence of pairs of a wave or in the amount of subintervals that a big wave is constantly exchanging with another big wave, either with its already entangled samples or especially with its unentangled samples (virtual cloud - unentangled samples), which allows the reorganization of these waves continuously, similar to what happens strongly with magnets, due to the low entropy, according to the subsection of the electromagnetic force. As an example, the entanglements of larger waves of a car (car parts) can occur with greater to lesser vigor, such as the fusion of parts or soldering, glues, and so on. Thus, the engine and wheels of a car when accelerating and braking respectively, equally accelerate and decelerate its most strongly entangled parts, while the weakly entangled parts such as objects and occupants loose inside suffer from inertia. With magnets something similar occurs, since by moving a magnet one can also move the parts more strongly entangled to it. Entanglement also occurs in distant waves, such as atomic nuclei and their electrons, nuclei of stellar systems and their planets, galactic nuclei and their stars, among others. The nuclei of these systems are the densest parts of their waves and even distant ones cause probabilistic influences in the small intervals of the smaller waves inside them, which provides entanglements. 
