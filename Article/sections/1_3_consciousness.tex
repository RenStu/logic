...
The vigor of an entanglement is the number of subintervals that one wave has entangled with another. Increasing the vigor of an entanglement occurs more easily when the waves of a system are born with the system, so the greater the interval, the greater the number of possible subintervals and the greater the chances of them becoming entangled with each other, due to the probabilistic distribution of the population (the samples are predisposed yet random), which makes these intervals more and more stable as they grow. It is also possible to have an increase in vigor when one interval converges with another and remain that way for a period in which its subintervals are influenced by the peak of the system, to the point that their entangled pairs are within the same population discrepancy even though they were not born of this population discrepancy to which they came to belong. The amount of subintervals that a wave is constantly sharing with another wave is what guarantees a greater or lesser synchronism of the movements of these waves, according to the subsection of Space. 

As an example, the entanglement of waves or larger parts of a car (car parts) can occur with greater to lesser vigor, such as the fusion of parts or welding, glues, something more elastic, among others. Thus, the engine and wheels of a car when accelerating and braking respectively, equally accelerate and decelerate its entangled parts. The less vigorous the entanglements, the more the parts suffer from inertia, such as loose objects and occupants inside a vehicle. 
...
When a subinterval is part of the peak, its development is accelerated by receiving more samples, which goes far beyond movements and reactions. When this subinterval is outside the peak it receives much less samples and its changes, to a large extent, are due to the movement and reactions of the subintervals once created in the peak. The peak constantly moves towards the median even though the expansion of space expands the entire population, as shown in Figure \ref{fig:consciousness_space_volume_amplitude}.
...
The spatial plane is the representation of the infinite, of the [NOT BEING] in all its possibilities and from which the space-time flows emerge as its possibilities. That is, it is the representation of NOTHING, the void that mirrors or represents all possibilities and it is present at all scales between any spatial and temporal possibility. This plane also emerges within the scales of thought, where the exercises of prospections (future possibilities) emerge from the probabilities of a determined interval with this plane or logical flow of infinite possibilities. So, when thinking about NOTHING naturally this logical representation of empty and infinite space emerges.
...
A non-entangled subinterval only influences and is influenced by its upper interval when it is within it. Consequently, the same occurs with the entangled subintervals. A subinterval that has jumped continues to directly influence the upper interval of the side of the pair to which it originally belongs in the population, since this jump does not abruptly move the samples from one point to another in the population, that is, the sides of the entangled pair approach each other through the movement of their respective two-dimensional planes in the three-dimensional plane. In this way, shocks caused by virtual intervals (collision of two-dimensional planes in the three-dimensional plane) in each part of the entanglement, cause movement in this entanglement. Similarly shocks in the subintervals of the entangled pair (collision of three-dimensional subintervals), by any entangled subinterval, move the parts of this entangled pair. Thus, the entanglements of the subintervals tend to approximate their superior intervals due to the synchronism of their movements. The virtual subintervals (non-entangled) are also responsible for positioning their entangled upper intervals, by sharing their samples with the upper interval on their side of the pair. An entangled interval carries in its coordinates its virtual clouds of non-entangled subintervals. A fully two-dimensional view of these virtual subintervals is out of keeping with their nature.
...
The collision of subintervals that are towards the wave peak also makes a subinterval approach this wave peak.
...
When intervals have low entropy, the total or partial overlapping of their areas facilitates the reordering of their entangled pairs, and an example of this can be the overlapping of an electron's area with the photonic clouds of other electrons or atoms. This reordering is an attempt to equalize these waves into a single low-entropy wave, which also makes it feasible to exchange many of these pairs for those of the non-entangled virtual cloud (two-dimensional non-entangled subintervals), which may result in the approximation of these waves due to this reordering.

In Figure \ref{fig:consciousness_electromaagnetic_force}, the black arrows indicate the common probabilistic direction of the interval. Due to the low entropy, these directions are relevant for the vast majority of subintervals, entangled or non-entangled. And this common direction of the interval causes the non-entangled (two-dimensional) subintervals to follow this common direction culminating in collisions at the peak of the interval, the apex of the flow (the two-dimensional planes of the non-entangled intervals commonly move in the three-dimensional plane, as seen in the subsection on Space, Motion). These collisions create this flow where the most centralized subintervals (represented by the central black arrow) concentrate the greatest load of the flow due to the naturally greater distribution of samples in this region, which makes this part of the flow faster due to the high volume of collisions of the subintervals just arriving at the peak of the flow. This flow of the two-dimensional planes (non-entangled intervals) in the three-dimensional plane occurs naturally due to the common direction (peak of the interval), making the central part of the interval a return made possible by the collisions of the planes of the non-entangled subintervals newly arrived at the peak of the flow.
	\begin{figure}[H]
	...
	\floatfoot{Three-dimensional flow of two-dimensional non-interlaced subintervals.}%\footnotemark}
	\end{figure}
	%\footnotetext{Fonte: note}

The two-dimensional intervals do not interact directly with the three-dimensional intervals, as they are not completely present in this plane.
...
The inversion or change of the magnetic pole is the inversion or change of the common probabilistic direction of a given interval.
...
The expansion of intervals and subintervals is a probabilistic aspect that occurs due to the addition of new samples in the population, as shown in Figure \ref{fig:consciousness_space_volume_amplitude}. This expansion occurs in all intervals and subintervals of the population, however, its effects are more apparent between intervals with low gravity. In this way, there is a relationship between this expansion and attraction that can stimulate the approximation of intervals or affirm their distancing.
