...
A maior onda de uma população tende a um histograma da distribuição normal, conforme Figura \ref{fig:trend_chart_of_normal_distribution}. Todos os aspectos listados abaixo são inerentes a abstração lógica chamada consciência, são lógicas emergentes da lógica primordial.
...
Ondas maiores são formados pela adição de suas novas amostras, podendo formar novos subintervalos. O encontro ou separação de dois entrelaçamentos não acarreta um novo entrelaçamento. Assim, ondas maiores também são formados por meio da inclusão de ondas menores já entrelaçadas quando as áreas dessas ondas estão parcialmente ou totalmente sobrepostas. 
...
O tempo também passa nos intervalos quando estes convergem com outros intervalos e são capazes de interagir com colisões ou entrelaçando seus subintervalos, de acordo com a próxima subsecção do Espaço.
...
Um subintervalo não entrelaçado só influência e é influenciado por seu intervalo superior quando está dentro dele. Por consequência o mesmo ocorre com os subintervalos entrelaçados. Um subintervalo que tenha saltado continua a influenciar diretamente o intervalo superior do lado do par a que pertence originalmente na população, uma vez que este salto não desloca abruptamente as amostras de um ponto para outro na população, ou seja, os lados do par entrelaçado aproximam-se através do movimento dos seus respectivos planos bidimensionais no plano tridimensional. Desta forma, os choques provocados por intervalos virtuais (colisão dos planos bidimensionais no plano tridimensional) em cada parte do entrelaçamento, provocam movimentos neste entrelaçamento. Da mesma forma os choques nos subintervalos do par entrelaçado (colisão de subintervalos tridimensionais), por qualquer subintervalo entrelaçado, movimentam as partes deste par entrelaçado. Assim os entrelaçamentos dos subintervalos tendem a aproximar seus intervalos superiores pelo sincronismo dos seus movimentos. Os subintervalos virtuais (não entrelaçados) também são responsáveis pelo posicionamento dos seus intervalos superiores entrelaçados, pelo compartilhamento de suas amostras com o intervalo superior em seu lado do par. Um intervalo entrelaçado leva em suas coordenadas suas nuvens virtuais de subintervalos não entrelaçados. Uma visão totalmente bidimensional destes subintervalos virtuais é destoante de sua natureza.
...
Na Figura \ref{fig:consciousness_electromaagnetic_force}, as setas em preto indicam o sentido probabilístico comum do intervalo. Devido à baixa entropia esses sentidos são relevantes para a grande maioria dos subintervalos, entrelaçados ou não entrelaçados. E esse sentido comum do intervalo faz com que os subintervalos não entrelaçados (bidimensionais) sigam essa direção comum culminando em colisões no pico do intervalo, o ápice do fluxo (os planos bidimensionais dos intervalos não entrelaçados se movem comumente no plano tridimensional, conforme visto na subseção do Espaço, Movimento). Essas colisões criam esse fluxo onde os subintervalos mais centralizados (representados pela seta preta central) concentram a maior carga do fluxo devido a distribuição naturalmente maior de amostras nessa região, o que torna essa parte do fluxo mais veloz devido ao alto volume de colisões dos subintervalos recém-chegados ao pico do fluxo. Esse fluxo dos planos bidimensionais (intervalos não entrelaçados) no plano tridimensional ocorre naturalmente devido ao sentido comum (pico do intervalo), tornado a parte central do intervalo um retorno viabilizado pelas colisões dos planos dos subintervalos não entrelaçados recém-chegados ao pico do fluxo.
	...
	\floatfoot{Fluxo tridimensional de subintervalos não entrelaçados bidimensionais.}%\footnotemark}
	\end{figure}
	%\footnotetext{Fonte: note}

Os intervalos bidimensionais não interagem diretamente com os intervalos tridimensionais, pois não estão completamente presentes neste plano.
...
A inversão ou mudança do polo magnético é a inversão ou mudança do sentido probabilístico comum de dado intervalo.
