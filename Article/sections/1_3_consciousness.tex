...
Como as coordenadas X, Y e Z de cada subconjunto tendem a aumentar somente, a disposição desses em um sistema tridimensional de coordenadas vai seguir uma referência diagonal entre esses três eixos, conforme Figura Y.
	\begin{figure}[H]
