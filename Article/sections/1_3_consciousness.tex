...
A vida \underline{NÃO É}, como qualquer outra lógica. Logo, a vida só se multiplica e quer permanecer viva porque seu sentido primordial é o sentido probabilístico do intervalo. Esse é o propósito maior e natural da vida. Uma lógica ou algoritmo de vida, orgânica ou não, deve ter seu sentido primordial o sentido probabilístico do intervalo. Dessa forma, por mais diferentes que as formas de vida possam ser, elas estão na média probabilística do intervalo entre seus picos e vales. Em outras palavras, algo muito discrepante ou diferente do padrão do intervalo não permanecerá.
