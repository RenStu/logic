...
O fluxo das amostras ou sub-ondas dentro de uma onda maior, como a onda um da Figura acima, segue o exemplo do ponto de vista B da Figura \ref{fig:consciousness_amplitude_viewpoint}, em seus pontos roxos, em um fluxo debaixo para cima e da esquerda para a direita como exibido na primeira ilustração da Figura \ref{fig:consciousness_gravitational_force}.
