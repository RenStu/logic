...
The largest wave of a population tends to a histogram of the normal distribution, as shown in Figure \ref{fig:trend_chart_of_normal_distribution}. All aspects listed below are inherent in the logical abstraction called consciousness.
