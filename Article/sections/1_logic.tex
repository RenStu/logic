...
% ----------------------------------------------------------
\section{Lógica}
Segundo o dicionário online de Inglês Collins\cite{dicio_logica}, a palavra lógica se refere a:
	\begin{enumerate}
...
Assim essa sequência simultânea é uma recursão infinita e generalizada na ausência do tempo, a melhor definição de constante, que segundo o dicionário online de Inglês Collins\cite{dicio_constante}, é algo que se repete de maneira continua, sem interrupções e permanente, algo inalterável.
