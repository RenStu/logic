...
\subsection{Observações}
	\begin{description}
	   \item[Núcleo] A negação de si da lógica (ou nada) deu origem a três axiomas que são a base do teorema núcleo dessa teoria. Teorema esse que dá origem as ondas e a seu principal atributo, o entrelaçamento de ondas. 
