...
- **Intervalo - ]0,1[** - A lógica é possível apenas na representação das frações ou intervalos dos pontos **0** e **1**. Uma fração da reta nega ser a reta, pois é apenas uma parte dela. Os subintervalos, do mesmo modo, também são hábeis a negar a si infinitamente, garantindo a premissa primordial da lógica (negação de si) em todo o intervalo e seus subintervalos.
...
Quando os intervalos têm baixa entropia, a sobreposição total ou parcial de suas áreas facilita a reordenação de seus pares entrelaçados, e um exemplo disso pode ser a sobreposição da área do elétron com as nuvens fotônicas de outros elétrons ou átomos. Essa reordenação é uma tentativa de equalizar essas ondas em uma onda única de baixa entropia, o que também tornando viável a troca de muitos desses pares pelos da nuvem virtual não entrelaçada (subintervalos não entrelaçados bidimensionais), podendo resultar na aproximação dessas ondas devido a essa reordenação.

Na Figura abaixo, as setas em preto indicam o sentido probabilístico comum do intervalo. Devido à baixa entropia esses sentidos são relevantes para a grande maioria dos subintervalos, entrelaçados ou não entrelaçados. E esse sentido comum do intervalo faz com que os subintervalos não entrelaçados (bidimensionais) sigam essa direção comum culminando em colisões no pico do intervalo, o ápice do fluxo (os planos bidimensionais dos intervalos não entrelaçados se movem comumente no plano tridimensional, conforme visto na subseção do Espaço, Movimento). Essas colisões criam esse fluxo onde os subintervalos mais centralizados (representados pela seta preta central) concentram a maior carga do fluxo devido a distribuição naturalmente maior de amostras nessa região, o que torna essa parte do fluxo mais veloz devido ao alto volume de colisões dos subintervalos recém-chegados ao pico do fluxo. Esse fluxo dos planos bidimensionais (intervalos não entrelaçados) no plano tridimensional ocorre naturalmente devido ao sentido comum (pico do intervalo), tornado a parte central do intervalo um retorno viabilizado pelas colisões dos planos dos subintervalos não entrelaçados recém-chegados ao pico do fluxo.

<p align="center">Força eletromagnética</p>
<p align="center"><img width="50%" src="/Article/sections/images/consciousness_electromaagnetic_force.jpg"></p>
<p align="center">Fluxo tridimensional de subintervalos não entrelaçados bidimensionais.</p>
...
A expansão dos intervalos e subintervalos é um aspecto probabilístico que ocorre devido a adição de novas amostras na população, conforme visto na subseção de Comprimento e amplitude do artigo. Essa expansão ocorre em todos os intervalos e subintervalos da população, entretanto, seus efeitos são mais aparentes entre intervalos com baixa gravidade. Desta forma, existe uma relação entre essa expansão e atração que pode estimular a aproximação dos intervalos ou afirmar seus distanciamentos.
